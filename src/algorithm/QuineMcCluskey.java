...
public class QuineMcCluskey {
	...
	public int lengthOfBits = 0;
	public int noOfMinTerms = 0;
	public ArrayList<Integer> minTerms = new ArrayList<Integer>() ;
...
//		ArrayList<ArrayList<Object>> contain0 = new ArrayList<ArrayList<Object>>();
//		ArrayList<ArrayList<Object>> contain1 = new ArrayList<ArrayList<Object>>();
//		ArrayList<ArrayList<Object>> contain2 = new ArrayList<ArrayList<Object>>();
//		ArrayList<ArrayList<Object>> contain3 = new ArrayList<ArrayList<Object>>();
//		ArrayList<ArrayList<Object>> contain4 = new ArrayList<ArrayList<Object>>();
...
//		System.out.println(this.noOfNines(a1)+1);
...
//				result.add(tempo.get(i));
		...
		System.out.println(newResult.size());
		for(ArrayList<Integer> i: newResult) {
			System.out.println(i);
		}
		return newResult;
	}
...
//		ArrayList<ArrayList<Integer>> simply = this.simplifyImplicants(implicants);
//		String result = this.binToString(this.implicantsToBin(simply.get(0)));
//		for(int i=1; i<simply.size(); i++) {
//			result += " + " + this.binToString(this.implicantsToBin(simply.get(i)));
//		}
//		
//		return result;
		
//		ArrayList<ArrayList<Integer>> simply = this.newSimplifyImplicants(implicants);
...
//		this.setNoOfMinTerms(noOfMinTerms);
	...
	public int[][] result(int[]minTerms, int lengthBits){
		ArrayList<Integer> mT = new ArrayList<Integer>();
...
//		}
		...
		int [][]result = convert(temp);
		for(int i=0; i<result.length; i++) {
			for (int j=0; j<result[i].length; j++) System.out.println(result[i][j]);
		}
		return result;
	}
...
//                System.out.print(k);
		...
		for(int i=0; i<intArray.length; i++) {
			for (int j=0; j<intArray[i].length; j++) System.out.println(intArray[i][j]);
		}
		System.out.println();
		return intArray;
