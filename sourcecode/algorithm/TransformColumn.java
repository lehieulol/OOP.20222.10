...
public class TransformColumn {
	...
	private ArrayList<ArrayList<Integer>> collectPrimeImplicants = new ArrayList<ArrayList<Integer>>();
...
//			System.out.println(1);
		...
		this.collectPrimeImplicants = this.simplifyImplicants(k);
